          ...
          <div className="bg-linear-to-b from-[#EAECDC] to-[#D3D6BA] w-full border-t-8 flex-1 border-[#E2725B] flex flex-col pt-10 items-center">
            <form action="" className="flex flex-col justify-center items-center w-90 gap-8">
              <div className="flex gap-10">
                <button className="text-2xl px-8 py-2 bg-white rounded-2xl">Client</button>
                <button className="text-2xl px-8 py-2 bg-white rounded-2xl">Vendor</button>
              </div>
              <p className="text-xl text-[#40532D]">I want to join as a...</p>
              <input type="text" placeholder="First Name" required className="py-3 px-4 border w-full bg-white rounded-md text-[#D3D6BA]" />
              <input type="text" placeholder="Last Name" required className="py-3 px-4 border w-full bg-white rounded-md text-[#D3D6BA]" />
